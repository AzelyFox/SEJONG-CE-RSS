...
public class ItChecker extends Service {
	...
	private class NetTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... sId) {
			...
			try{
				...
				HttpGet httpget = new HttpGet("http://ce.sejong.ac.kr/main/skin/board/total_bbs/rss.skin.php?bo_table=co05&route=/main/bbs/board.php?bo_table=co05"); // Set the action you want to do
	...
	private Handler myHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			NotificationCompat.Builder builder =
				new NotificationCompat.Builder(ItChecker.this);
			...
			manager.notify(20154, builder.build());
		};
	};
