...
public class FreeChecker extends Service {
	...
	private class NetTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... sId) {
			...
			try{
				...
				HttpGet httpget = new HttpGet("http://ce.sejong.ac.kr/main/skin/board/total_bbs/rss.skin.php?bo_table=co01&route=/main/bbs/board.php?bo_table=co01"); // Set the action you want to do
	...
	private Handler myHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			NotificationCompat.Builder builder =
				new NotificationCompat.Builder(FreeChecker.this);
			...
			manager.notify(20153, builder.build());
		};
	};
